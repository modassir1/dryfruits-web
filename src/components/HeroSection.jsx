        ...
        <div className='container'>
            <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
                <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                    <img className='w-full h-full object-cover rounded-lg' src="/assets/hero__1.webp" alt="" />
                    <div className='absolute top-[50%] -translate-y-[50%] max-w-[470px] ml-8 sm:ml-16 sm:space-y-4'>
                        ...
                        <div className='bg-accent hover:bg-accentDark text-white rounded-full w-fit flex items-center gap-4 px-4 py-2 text-[14px] sm:px-6 sm:py-3 cursor-pointer'>Shop Now <BsArrowRight /></div>
                    </div>

                </div>

                <div className='relative'>
                    <img className='w-full h-full object-cover rounded-lg' src="/assets/hero__2.webp" alt="" />
                ...
                <div className='relative'>
                    <img className='w-full h-full object-cover rounded-lg' src="/assets/hero__3.webp" alt="" />
                    <div className='absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2'>
